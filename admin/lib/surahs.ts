...
/** The 114 surahs in canonical Qur'an order (id + simple name), used for the surah picker. */
export const SURAHS: SurahRef[] = [
...
export const getSurahById = (id: number): SurahRef | undefined =>
